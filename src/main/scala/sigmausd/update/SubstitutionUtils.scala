...
trait SubstitutionUtils {
  ...
  def substitutionMap: Map[String, (String, String)] = Map(
    ...
    "poolUpdatePreV2Nft" -> ("720978c041239e7d6eb249d801f380557126f6324e12c5ba9172d820be2e1dde", "00052cfea4e20f035368796a5269d38302a491141c02f0e22b8319753b61eb90"), //todo: update
